    ...
    return {
        ...
        plugins: [
            ...
            new WebpackSSRPlugin({
                createDataProps: true,
                verbose: isProduction ? false : true,
                metaDisplay: isProduction ? false : true,
                metaFile: isProduction ? true : false,
                envFile: isProduction ? '.env' : '.env.development',
            }),
